...
import classes from "./JobsSkill.module.css";
  ...
  return (
    <div className={classes.main}>
      <div className={classes.main1}>
        <h1 className={classes.main2}>Jobs by Skill</h1>
        {isPending && <div>Loading...</div>}
        <ul className={classes.ul}>
          {skillsColumns.map((item, index) => (
