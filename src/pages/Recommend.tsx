              ...
              <div className={classes.comment}>
                <div className={classes.comment1}>
                  <div className={classes.comment2}>
                    ...
                    >
                      {" "}
                      Thật sự mình đã làm tại nhiều cty nhưng để lại ấn tượng
                      nhất vẫn là NFQ, cty hiện tại của mình. Đầu tiên, mức
                      lương và phúc lợi tại đây thực sự rất tốt so với mặt bằng
                      chung trên thị trường. Thay vì 1 năm có 12 ngày nghỉ phép
                      như các cty...
                    </Typography>
                  </div>
                </div>
